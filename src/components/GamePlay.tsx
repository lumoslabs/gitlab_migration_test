...
export default function GamePlay({ game, onFinishHandler, isTraining, scoreActionButtonText }: { game: GameConfig, onFinishHandler: () => void, isTraining: boolean, scoreActionButtonText?: string }): JSX.Element {
  ...
  const actionButtonText = scoreActionButtonText ? scoreActionButtonText : 'Main Menu'
